...
public class OtherUtility
{
    ...
    {
        List<string> parmList = OtherUtility.String2ListString(parmStr, "&");
        Dictionary<string, string> kVDict = new Dictionary<string, string>();
        for (int i = 0; i < parmList.Count; ++i)
        {
            List<string> parms = OtherUtility.String2ListString(parmList[i], "=");
            if (parms.Count == 2)
            {
    ...
    public static List<int> String2ListInt(string value, string splitter = ";")
    {
        ...
        {
            list.Add(OtherUtility.String2Int(strArray[i]));
        }
    ...
    public static List<float> String2ListFloat(string value, string splitter = ";")
    {
        ...
        for (int i = 0; i < strArray.Length; i++)
        {
            list.Add(OtherUtility.String2Float(strArray[i]));
        }
    ...
    public static List<bool> String2ListBool(string value, string splitter = ";")
    {
        ...
        for (int i = 0; i < strArray.Length; i++)
        {
            list.Add(OtherUtility.String2Bool(strArray[i]));
        }
    ...
    public static int[] String2IntArray(string data, string split = "-")
    {
        ...
        for (int i = 0; i < strArray.Length; ++i)
        {
            ret[i] = OtherUtility.String2Int(strArray[i]);
        }
    ...
    */
    ...
    public static int QueryIntArgs(object[] args, int index)
    {
        ...
        {
            return OtherUtility.String2Int((string)obj);
        }
    ...
    public static LWFramework.Core.BaseLicense license = new LWFramework.Core.LicenseLocalDate();
    // 获取函数的函数名
