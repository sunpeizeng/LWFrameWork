...
public class FileTool
{
    ...
    public static void WriteToFile(string fileFullName, string content, string dirPath,bool isAdd= true)
    {
        string filePath = Path.Combine(dirPath, fileFullName);
        WriteToFile(filePath, content,isAdd);
    }
    public static void WriteToFile(string fileFullPath, string content, bool isAdd = true)
    {
